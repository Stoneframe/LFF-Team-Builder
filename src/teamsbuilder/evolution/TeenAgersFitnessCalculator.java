...
public class TeenAgersFitnessCalculator
	implements
		FitnessCalculator
{
	...
	public TeenAgersFitnessCalculator(double optimalValue)
	{
	...
	{
		double diff = Math.abs(optimalValue - team.count(NumberOf.TEEN_AGERS));
